...
{       //  category              name                        actor (function)           okSafeMode
        ...
        { "wallet",             "liststakingaddresses",     &liststakingaddresses,     true  },
...
{ "wallet",             "getreceivedbyaccount",     &getreceivedbylabel,       true  },
...
{ "wallet",             "getreceivedbylabel",       &getreceivedbylabel,       true  },
