...
UniValue dumpwallet(const JSONRPCRequest& request)
{
    ...
    if (!seed_id.IsNull())
    {
        ...
        if (pwalletMain->GetKey(seed_id, seed)) {
            ...
            CExtKey changeKey;             //key at m/purpose'/coin_type'/account'/change ---> key at m/44'/BIP32_HDCHAIN'/0'/HDChain::ChangeType::STAKING.
            ...
            accountKey.Derive(changeKey, HDChain::ChangeType::STAKING);
