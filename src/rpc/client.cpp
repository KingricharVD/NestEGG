...
static const CRPCConvertParam vRPCConvertParams[] =
    {
        ...
        {"delegatorremove", 4},
        {"delegatorremove", 5},
        {"rawdelegatorremove", 1},
        {"rawdelegatorremove", 3},
        {"rawdelegatorremove", 4},
        {"sendtoaddress", 1},
        {"sendtoaddressix", 1},
        {"settxfee", 0},
        {"getnewshieldedaddreds", 1},
        {"getreceivedbyaccount", 1},
        {"getreceivedbylabel", 1},
        {"listcoldutxos", 0},
        {"listdelegators", 0},
        {"listshieldedaddresses", 0},
        {"listshieldedaddresses", 1},
        {"listshieldedaddresses", 2},
