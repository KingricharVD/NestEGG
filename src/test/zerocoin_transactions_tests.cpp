...
BOOST_AUTO_TEST_CASE(zerocoin_public_spend_test)
{
    ...
    tx1.vout[0].scriptPubKey = GetScriptForStakeDelegation(DecodeDestination("D9Ti4LEhF1n6dR2hGd2SyNADD51AVgva6q"));
    tx2.vout.resize(1);
    tx2.vout[0].nValue = 1*CENT;
    tx2.vout[0].scriptPubKey = GetScriptForStakeDelegation(DecodeDestination("D9Ti4LEhF1n6dR2hGd2SyNADD51AVgva6q"));
    tx3.vout.resize(1);
    tx3.vout[0].nValue = 1*CENT;
    tx3.vout[0].scriptPubKey = GetScriptForStakeDelegation(DecodeDestination("D9Ti4LEhF1n6dR2hGd2SyNADD51AVgva6q"));
