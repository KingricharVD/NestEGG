...
public:
    ...
    /** 
     * Amount of Human_Charity_Coin_Protocol coming in to a transaction
...
// Human_Charity_Coin_Protocol: It assumes that overwrites are never possible due to BIP34 always in effect
