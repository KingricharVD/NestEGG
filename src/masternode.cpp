...
// Copyright (c) 2020-2021 Human Charity Coin Protocol Core Developers
...
void CMasternode::Check(bool forceCheck)
{
    ...
    if (!unitTest) {
        ...
        CTxOut vout = CTxOut(GetMasternodeNodeCollateral(chainActive.Height()) - (COIN / 100), dummyScript);
