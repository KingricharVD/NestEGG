...
public:
  ...
  //TODO: Set hashMerkleRoot. CLUE: Mining Testnet genesis block will give the hashMerkleRoot which will be the same as Mainnet.
      ...
      consensus.powLimit   = ~UINT256_ZERO >> 20;   // Human_Charity_Coin_Protocol starting difficulty is 1 / 2^12
      ...
      consensus.nTime_RejectOldSporkKey = 1556165178;     //!> September 26, 2019 11:00:00 PM GMT
        ...
        consensus.ZC_Modulus = "25195908475657893494027183240048398571429282126204032027777137836043662020707595556264018525880784"
              ...
              consensus.ZC_MinMintConfirmations = 25;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_CHECK_WORK_V2].nActivationHeight          = 5001;
...
public:
    CTestNetParams()
    {
      networkID = CBaseChainParams::TESTNET;
        ...
        vSeeds.emplace_back(CDNSSeedData("seed1.Human_Charity_Coin_Protocolcoin.com", "seed1.Human_Charity_Coin_Protocolcoin.com", true));
        vSeeds.emplace_back(CDNSSeedData("seed2.Human_Charity_Coin_Protocolcoin.com", "seed2.Human_Charity_Coin_Protocolcoin.com", true));
        vSeeds.emplace_back(CDNSSeedData("seed3.Human_Charity_Coin_Protocolcoin.com", "seed3.Human_Charity_Coin_Protocolcoin.com", true));
        vSeeds.emplace_back(CDNSSeedData("seed4.Human_Charity_Coin_Protocolcoin.com", "seed4.Human_Charity_Coin_Protocolcoin.com", true));
        vSeeds.emplace_back(CDNSSeedData("seed5.Human_Charity_Coin_Protocolcoin.com", "seed5.Human_Charity_Coin_Protocolcoin.com", true));
        vSeeds.emplace_back(CDNSSeedData("seed6.Human_Charity_Coin_Protocolcoin.com", "seed6.Human_Charity_Coin_Protocolcoin.com", true));
        vSeeds.emplace_back(CDNSSeedData("seed7.Human_Charity_Coin_Protocolcoin.com", "seed7.Human_Charity_Coin_Protocolcoin.com", true));
        vSeeds.emplace_back(CDNSSeedData("seed8.Human_Charity_Coin_Protocolcoin.com", "seed8.Human_Charity_Coin_Protocolcoin.com", true));


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet Human_Charity_Coin_Protocol addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet Human_Charity_Coin_Protocol script addresses start with '8' or '9'
        ...
        // Testnet Human_Charity_Coin_Protocol BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        ...
        // Testnet Human_Charity_Coin_Protocol BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        ...
        // Testnet Human_Charity_Coin_Protocol BIP44 coin type is '1' (All coin's testnet default)
