                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Human_Charity_Coin_Protocol") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About Human_Charity_Coin_Protocol"));
        ...
        QString header = tr("Usage:") + "\n" +
                         "  Human_Charity_Coin_Protocol-qt [" + tr("command-line options") + "]                     " + "\n";
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Human_Charity_Coin_Protocol is shutting down...") + "<br /><br />" +
