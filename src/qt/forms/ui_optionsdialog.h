...
public:
    ...
    QWidget *verticalZpivOptionsWidget;
    QVBoxLayout *verticalZpivOptionsLayout;
    ...
    QWidget *verticalZpivDisplayWidget;
    QVBoxLayout *verticalZpivDisplayLayout;
    QFrame *line;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        verticalZpivOptionsWidget = new QWidget(tabMain);
        verticalZpivOptionsWidget->setObjectName(QStringLiteral("verticalZpivOptionsWidget"));
        verticalZpivOptionsLayout = new QVBoxLayout(verticalZpivOptionsWidget);
        verticalZpivOptionsLayout->setContentsMargins(0, 0, 0, 0);
        verticalZpivOptionsLayout->setObjectName(QStringLiteral("verticalZpivOptionsLayout"));
        ...
        checkBoxZeromintEnable = new QCheckBox(verticalZpivOptionsWidget);
        ...
        checkBoxZeromintAddresses = new QCheckBox(verticalZpivOptionsWidget);
        ...
        verticalZpivOptionsLayout->addLayout(horizontalAutomintingLayout);
        ...
        verticalZpivOptionsLayout->addLayout(horizontalZmintPercentageLayout);

        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName(QStringLiteral("horizontalLayout"));
        horizontalLayout->setSizeConstraint(QLayout::SetFixedSize);
        labelPreferredDenom = new QLabel(verticalZpivOptionsWidget);
        ...
        preferredDenom = new QComboBox(verticalZpivOptionsWidget);
        ...
        verticalZpivOptionsLayout->addLayout(horizontalLayout);


        verticalLayout_Main->addWidget(verticalZpivOptionsWidget);
        ...
        verticalZpivDisplayWidget = new QWidget(tabDisplay);
        verticalZpivDisplayWidget->setObjectName(QStringLiteral("verticalZpivDisplayWidget"));
        verticalZpivDisplayLayout = new QVBoxLayout(verticalZpivDisplayWidget);
        verticalZpivDisplayLayout->setContentsMargins(0, 0, 0, 0);
        verticalZpivDisplayLayout->setObjectName(QStringLiteral("verticalZpivDisplayLayout"));
        line = new QFrame(verticalZpivDisplayWidget);
        line->setObjectName(QStringLiteral("line"));
        line->setFrameShape(QFrame::HLine);
        line->setFrameShadow(QFrame::Sunken);

        verticalZpivDisplayLayout->addWidget(line);
        ...
        unitLabel = new QLabel(verticalZpivDisplayWidget);
        ...
        unit = new QValueComboBox(verticalZpivDisplayWidget);
        unit->setObjectName(QStringLiteral("unit"));

        horizontalLayout_3_Display->addWidget(unit);


        verticalZpivDisplayLayout->addLayout(horizontalLayout_3_Display);
        ...
        checkBoxHideZeroBalances = new QCheckBox(verticalZpivDisplayWidget);
        ...
        checkBoxHideOrphans = new QCheckBox(verticalZpivDisplayWidget);
        ...
        verticalZpivDisplayLayout->addLayout(horizontalLayout_5_Display);
        ...
        thirdPartyTxUrlsLabel = new QLabel(verticalZpivDisplayWidget);
        ...
        thirdPartyTxUrls = new QLineEdit(verticalZpivDisplayWidget);
        thirdPartyTxUrls->setObjectName(QStringLiteral("thirdPartyTxUrls"));

        horizontalLayout_6_Display->addWidget(thirdPartyTxUrls);


        verticalZpivDisplayLayout->addLayout(horizontalLayout_6_Display);


        verticalLayout_Display->addWidget(verticalZpivDisplayWidget);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start NestEgg after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start NestEgg on system login", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        checkBoxZeromintEnable->setToolTip(QApplication::translate("OptionsDialog", "Enable automatic minting of EGG units to zEGG", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxZeromintEnable->setText(QApplication::translate("OptionsDialog", "Enable zEGG Automint", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxZeromintAddresses->setToolTip(QApplication::translate("OptionsDialog", "Enable automatic zEGG minting from specific addresses", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxZeromintAddresses->setText(QApplication::translate("OptionsDialog", "Enable Automint Addresses", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        percentage_label->setToolTip(QApplication::translate("OptionsDialog", "Percentage of incoming EGG which get automatically converted to zEGG via Zerocoin Protocol (min: 10%)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        percentage_label->setText(QApplication::translate("OptionsDialog", "Percentage of autominted zEGG", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelPreferredDenom->setToolTip(QApplication::translate("OptionsDialog", "Wait with automatic conversion to Zerocoin until enough EGG for this denomination is available", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelPreferredDenom->setText(QApplication::translate("OptionsDialog", "Preferred Automint zEGG Denomination", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        preferredDenom->setToolTip(QApplication::translate("OptionsDialog", "Wait with automatic conversion to Zerocoin until enough EGG for this denomination is available", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the NestEgg client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the NestEgg network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting NestEgg.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/pivx-project/pivx-project-translations", Q_NULLPTR));
