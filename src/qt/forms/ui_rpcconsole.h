...
public:
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the NestEgg debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        wallet_customzpivbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zEGG Backup Path:", Q_NULLPTR));
