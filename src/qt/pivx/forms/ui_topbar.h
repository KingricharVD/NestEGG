...
public:
    ...
    void setupUi(QWidget *TopBar)
    {
        ...
        labelAmountTopPiv->setText(QStringLiteral("480.0685 EGG"));
        ...
        labelAmountPiv->setText(QStringLiteral("480.0685 EGG"));
        ...
        labelPendingPiv->setText(QStringLiteral("6.943 EGG"));
        ...
        labelImmaturePiv->setText(QStringLiteral("10 EGG"));
