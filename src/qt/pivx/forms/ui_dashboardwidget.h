...
public:
    ...
    void setupUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountPiv->setText(QStringLiteral("0 EGG"));
        ...
        labelAmountZpiv->setText(QStringLiteral("0 zEGG"));
        ...
        labelPiv->setText(QStringLiteral("EGG"));
        ...
        labelZpiv->setText(QStringLiteral("zEGG"));
...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        btnHowTo->setText(QApplication::translate("DashboardWidget", "How to get EGG", Q_NULLPTR));
        labelTitle2->setText(QApplication::translate("DashboardWidget", "Staking Rewards", Q_NULLPTR));
        labelMessage->setText(QApplication::translate("DashboardWidget", "Amount of EGG and zEGG staked.", Q_NULLPTR));
