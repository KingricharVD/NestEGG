...
"                   padding:0px;"));
    ...
    void retranslateUi(QWidget *ColdStakingWidget)
    {
        ...
        labelSubtitle1->setText(QApplication::translate("ColdStakingWidget", "You can delegate your EGGs, letting a hot node (24/7 online node)\n"
"stake on your behalf, while you keep the keys securely offline.", Q_NULLPTR));
        ...
        labelSubtitle2->setText(QApplication::translate("ColdStakingWidget", "Accept EGG delegation / Delegate EGG", Q_NULLPTR));
