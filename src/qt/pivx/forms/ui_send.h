...
"             }"));
        ...
        labelAmountSend->setText(QStringLiteral("0.00 EGG"));
    ...
    void retranslateUi(QWidget *send)
    {
        ...
        labelSubtitle1->setText(QApplication::translate("send", "Send public coins (EGG)", Q_NULLPTR));
        labelSubtitleAddress->setText(QApplication::translate("send", "NestEgg address or contact label", Q_NULLPTR));
