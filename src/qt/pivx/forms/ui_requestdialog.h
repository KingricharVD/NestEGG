...
public:
    ...
    void retranslateUi(QDialog *RequestDialog)
    {
        ...
        labelMessage->setText(QApplication::translate("RequestDialog", "Instead of sharing only a NestEgg address, you can create a payment request, bundling up more information", Q_NULLPTR));
        labelSubtitleAmount->setText(QApplication::translate("RequestDialog", "Amount", Q_NULLPTR));
        comboBoxCoin->setText(QApplication::translate("RequestDialog", "EGG", Q_NULLPTR));
