...
#define MyAppName "Human_Charity_Coin_Protocol Core"
#define MyAppPublisher "2021 Human_Charity_Coin_Protocol Core Developers"
#define MyAppURL "https://www.humancharitycoin.com"
#define MyAppExeName "Human_Charity_Coin_Protocol-qt.exe"
#define MyAppExtraData "https://explorer.Human_Charity_Coin_Protocol.net/bootstraps/HCCP/bootstrap.zip"
...
DefaultDirName={autopf}\Human_Charity_Coin_Protocol
...
OutputDir=.\output
OutputBaseFilename=Human_Charity_Coin_ProtocolSetup
...
DefaultGroupName=Human_Charity_Coin_Protocol Core
...
[Files]
Source: ".\package\Human_Charity_Coin_Protocol-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Human_Charity_Coin_Protocol\Human_Charity_Coin_Protocol-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Human_Charity_Coin_Protocol\Human_Charity_Coin_Protocol-Qt,strDataDir|{userappdata}\Human_Charity_Coin_Protocol\}');
  Result := True;
end;
