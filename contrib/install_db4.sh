...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the Human_Charity_Coin_Protocol repository."
  exit 1
fi
...
echo
echo 'When compiling Human_Charity_Coin_Protocold, run `./configure` in the following way:'
echo
