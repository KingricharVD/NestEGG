...
"""Verify that starting Human_Charity_Coin_Protocol with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start Human_Charity_Coin_Protocol with -? for help text")
        ...
        self.log.info("Start Human_Charity_Coin_Protocol with -version for version information")
