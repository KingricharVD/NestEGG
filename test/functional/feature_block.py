...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure Human_Charity_Coin_Protocold isn't accepting b26
        ...
        # Extend the b28 chain to make sure Human_Charity_Coin_Protocold isn't accepting b28
