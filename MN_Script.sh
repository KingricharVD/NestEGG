...
COIN_GETDMN='https://github.com/SirElven8/NestEGG/releases/download/v1.5/nesteggd'
COIN_GETCLI='https://github.com/SirElven8/NestEGG/releases/download/v1.5/nestegg-cli'
COIN_NAME='NestEGG'
