...
These are the dependencies currently used by Human_Charity_Coin_Protocol Core. You can find instructions for installing them in the `build-*.md` file for your platform.
