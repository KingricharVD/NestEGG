...
Gitian is the deterministic build process that is used to build the NestEgg
...
to the NestEgg GitHub release page.
...
- [Building NestEgg Core](#building-nestegg-core)
