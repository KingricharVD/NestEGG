Contributing to Human_Charity_Coin_Protocol Core
============================

The Human_Charity_Coin_Protocol Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Qt* for changes to Human_Charity_Coin_Protocol-qt
  - *Minting* for changes to the minting code
  - *Net* or *P2P* for changes to the peer-to-peer network code
  - *RPC/REST* for changes to the RPC or REST APIs
  - *Scripts and tools* for changes to the scripts and tools
  - *Tests* for changes to the Human_Charity_Coin_Protocol Coreunit tests or QA tests
...
The following applies to code changes to the Human_Charity_Coin_Protocol Core project, and is not to be
confused with overall Human_Charity_Coin_Protocol Network Protocol consensus changes.

Whether a pull request is merged into Human_Charity_Coin_Protocol Core rests with the project merge
...
Patches that change Human_Charity_Coin_Protocol consensus rules are considerably more involved than
...
Where a patchset proposes to change the Human_Charity_Coin_Protocol consensus, it must have been
...
The project leader is the release manager for each Human_Charity_Coin_Protocol Core release.
