Contributing to NestEgg Core


The NestEgg Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NestEgg Core project, and is not to be
confused with overall NestEgg Network Protocol consensus changes.

Whether a pull request is merged into NestEgg Core rests with the project merge
...
Patches that change NestEgg consensus rules are considerably more involved than
...
Where a patchset proposes to change the NestEgg consensus, it must have been
...
The project leader is the release manager for each NestEgg Core release.
