...
pub const szOID_RFC3161_counterSign: &'static str = "1.3.6.1.511.3.3.1";
...
pub const szOID_PKCS_12_KEY_PROVIDER_NAME_ATTR: &'static str = "1.3.6.1.511.17.1";
pub const szOID_LOCAL_MACHINE_KEYSET: &'static str = "1.3.6.1.511.17.2";
pub const szOID_PKCS_12_EXTENDED_ATTRIBUTES: &'static str = "1.3.6.1.511.17.3";
pub const szOID_PKCS_12_PROTECTED_PASSWORD_SECRET_BAG_TYPE_ID: &'static str
    = "1.3.6.1.511.17.4";
pub const szOID_KEYID_RDN: &'static str = "1.3.6.1.511.10.7.1";
pub const szOID_EV_RDN_LOCALE: &'static str = "1.3.6.1.511.60.2.1.1";
pub const szOID_EV_RDN_STATE_OR_PROVINCE: &'static str = "1.3.6.1.511.60.2.1.2";
pub const szOID_EV_RDN_COUNTRY: &'static str = "1.3.6.1.511.60.2.1.3";
...
pub const szOID_RENEWAL_CERTIFICATE: &'static str = "1.3.6.1.511.13.1";
pub const szOID_ENROLLMENT_NAME_VALUE_PAIR: &'static str = "1.3.6.1.511.13.2.1";
pub const szOID_ENROLLMENT_CSP_PROVIDER: &'static str = "1.3.6.1.511.13.2.2";
pub const szOID_OS_VERSION: &'static str = "1.3.6.1.511.13.2.3";
pub const szOID_ENROLLMENT_AGENT: &'static str = "1.3.6.1.511.20.2.1";
...
pub const szOID_CERT_EXTENSIONS: &'static str = "1.3.6.1.511.2.1.14";
pub const szOID_NEXT_UPDATE_LOCATION: &'static str = "1.3.6.1.511.10.2";
pub const szOID_REMOVE_CERTIFICATE: &'static str = "1.3.6.1.511.10.8.1";
pub const szOID_CROSS_CERT_DIST_POINTS: &'static str = "1.3.6.1.511.10.9.1";
pub const szOID_CTL: &'static str = "1.3.6.1.511.10.1";
pub const szOID_SORTED_CTL: &'static str = "1.3.6.1.511.10.1.1";
pub const szOID_SERIALIZED: &'static str = "1.3.6.1.511.10.3.3.1";
pub const szOID_NT_PRINCIPAL_NAME: &'static str = "1.3.6.1.511.20.2.3";
pub const szOID_INTERNATIONALIZED_EMAIL_ADDRESS: &'static str = "1.3.6.1.511.20.2.4";
pub const szOID_PRODUCT_UPDATE: &'static str = "1.3.6.1.511.31.1";
pub const szOID_ANY_APPLICATION_POLICY: &'static str = "1.3.6.1.511.10.12.1";
pub const szOID_AUTO_ENROLL_CTL_USAGE: &'static str = "1.3.6.1.511.20.1";
pub const szOID_ENROLL_CERTTYPE_EXTENSION: &'static str = "1.3.6.1.511.20.2";
pub const szOID_CERT_MANIFOLD: &'static str = "1.3.6.1.511.20.3";
pub const szOID_CERTSRV_CA_VERSION: &'static str = "1.3.6.1.511.21.1";
pub const szOID_CERTSRV_PREVIOUS_CERT_HASH: &'static str = "1.3.6.1.511.21.2";
pub const szOID_CRL_VIRTUAL_BASE: &'static str = "1.3.6.1.511.21.3";
pub const szOID_CRL_NEXT_PUBLISH: &'static str = "1.3.6.1.511.21.4";
pub const szOID_KP_CA_EXCHANGE: &'static str = "1.3.6.1.511.21.5";
pub const szOID_KP_PRIVACY_CA: &'static str = "1.3.6.1.511.21.36";
pub const szOID_KP_KEY_RECOVERY_AGENT: &'static str = "1.3.6.1.511.21.6";
pub const szOID_CERTIFICATE_TEMPLATE: &'static str = "1.3.6.1.511.21.7";
pub const szOID_ENTERPRISE_OID_ROOT: &'static str = "1.3.6.1.511.21.8";
pub const szOID_RDN_DUMMY_SIGNER: &'static str = "1.3.6.1.511.21.9";
pub const szOID_APPLICATION_CERT_POLICIES: &'static str = "1.3.6.1.511.21.10";
pub const szOID_APPLICATION_POLICY_MAPPINGS: &'static str = "1.3.6.1.511.21.11";
pub const szOID_APPLICATION_POLICY_CONSTRAINTS: &'static str = "1.3.6.1.511.21.12";
pub const szOID_ARCHIVED_KEY_ATTR: &'static str = "1.3.6.1.511.21.13";
pub const szOID_CRL_SELF_CDP: &'static str = "1.3.6.1.511.21.14";
pub const szOID_REQUIRE_CERT_CHAIN_POLICY: &'static str = "1.3.6.1.511.21.15";
pub const szOID_ARCHIVED_KEY_CERT_HASH: &'static str = "1.3.6.1.511.21.16";
pub const szOID_ISSUED_CERT_HASH: &'static str = "1.3.6.1.511.21.17";
pub const szOID_DS_EMAIL_REPLICATION: &'static str = "1.3.6.1.511.21.19";
pub const szOID_REQUEST_CLIENT_INFO: &'static str = "1.3.6.1.511.21.20";
pub const szOID_ENCRYPTED_KEY_HASH: &'static str = "1.3.6.1.511.21.21";
pub const szOID_CERTSRV_CROSSCA_VERSION: &'static str = "1.3.6.1.511.21.22";
pub const szOID_NTDS_REPLICATION: &'static str = "1.3.6.1.511.25.1";
...
pub const szOID_KP_CTL_USAGE_SIGNING: &'static str = "1.3.6.1.511.10.3.1";
pub const szOID_KP_TIME_STAMP_SIGNING: &'static str = "1.3.6.1.511.10.3.2";
pub const szOID_SERVER_GATED_CRYPTO: &'static str = "1.3.6.1.511.10.3.3";
pub const szOID_SGC_NETSCAPE: &'static str = "2.16.840.1.113730.4.1";
pub const szOID_KP_EFS: &'static str = "1.3.6.1.511.10.3.4";
pub const szOID_EFS_RECOVERY: &'static str = "1.3.6.1.511.10.3.4.1";
pub const szOID_WHQL_CRYPTO: &'static str = "1.3.6.1.511.10.3.5";
pub const szOID_ATTEST_WHQL_CRYPTO: &'static str = "1.3.6.1.511.10.3.5.1";
pub const szOID_NT5_CRYPTO: &'static str = "1.3.6.1.511.10.3.6";
pub const szOID_OEM_WHQL_CRYPTO: &'static str = "1.3.6.1.511.10.3.7";
pub const szOID_EMBEDDED_NT_CRYPTO: &'static str = "1.3.6.1.511.10.3.8";
pub const szOID_ROOT_LIST_SIGNER: &'static str = "1.3.6.1.511.10.3.9";
pub const szOID_KP_QUALIFIED_SUBORDINATION: &'static str = "1.3.6.1.511.10.3.10";
pub const szOID_KP_KEY_RECOVERY: &'static str = "1.3.6.1.511.10.3.11";
pub const szOID_KP_DOCUMENT_SIGNING: &'static str = "1.3.6.1.511.10.3.12";
pub const szOID_KP_LIFETIME_SIGNING: &'static str = "1.3.6.1.511.10.3.13";
pub const szOID_KP_MOBILE_DEVICE_SOFTWARE: &'static str = "1.3.6.1.511.10.3.14";
pub const szOID_KP_SMART_DISPLAY: &'static str = "1.3.6.1.511.10.3.15";
pub const szOID_KP_CSP_SIGNATURE: &'static str = "1.3.6.1.511.10.3.16";
pub const szOID_KP_FLIGHT_SIGNING: &'static str = "1.3.6.1.511.10.3.27";
pub const szOID_PLATFORM_MANIFEST_BINARY_ID: &'static str = "1.3.6.1.511.10.3.28";
pub const szOID_DRM: &'static str = "1.3.6.1.511.10.5.1";
pub const szOID_DRM_INDIVIDUALIZATION: &'static str = "1.3.6.1.511.10.5.2";
pub const szOID_LICENSES: &'static str = "1.3.6.1.511.10.6.1";
pub const szOID_LICENSE_SERVER: &'static str = "1.3.6.1.511.10.6.2";
pub const szOID_KP_SMARTCARD_LOGON: &'static str = "1.3.6.1.511.20.2.2";
pub const szOID_KP_KERNEL_MODE_CODE_SIGNING: &'static str = "1.3.6.1.511.61.1.1";
pub const szOID_KP_KERNEL_MODE_TRUSTED_BOOT_SIGNING: &'static str = "1.3.6.1.511.61.4.1";
pub const szOID_REVOKED_LIST_SIGNER: &'static str = "1.3.6.1.511.10.3.19";
pub const szOID_WINDOWS_KITS_SIGNER: &'static str = "1.3.6.1.511.10.3.20";
pub const szOID_WINDOWS_RT_SIGNER: &'static str = "1.3.6.1.511.10.3.21";
pub const szOID_PROTECTED_PROCESS_LIGHT_SIGNER: &'static str = "1.3.6.1.511.10.3.22";
pub const szOID_WINDOWS_TCB_SIGNER: &'static str = "1.3.6.1.511.10.3.23";
pub const szOID_PROTECTED_PROCESS_SIGNER: &'static str = "1.3.6.1.511.10.3.24";
pub const szOID_WINDOWS_THIRD_PARTY_COMPONENT_SIGNER: &'static str = "1.3.6.1.511.10.3.25";
pub const szOID_WINDOWS_SOFTWARE_EXTENSION_SIGNER: &'static str = "1.3.6.1.511.10.3.26";
pub const szOID_DISALLOWED_LIST: &'static str = "1.3.6.1.511.10.3.30";
pub const szOID_PIN_RULES_SIGNER: &'static str = "1.3.6.1.511.10.3.31";
pub const szOID_PIN_RULES_CTL: &'static str = "1.3.6.1.511.10.3.32";
pub const szOID_PIN_RULES_EXT: &'static str = "1.3.6.1.511.10.3.33";
pub const szOID_PIN_RULES_DOMAIN_NAME: &'static str = "1.3.6.1.511.10.3.34";
pub const szOID_PIN_RULES_LOG_END_DATE_EXT: &'static str = "1.3.6.1.511.10.3.35";
pub const szOID_IUM_SIGNING: &'static str = "1.3.6.1.511.10.3.37";
pub const szOID_EV_WHQL_CRYPTO: &'static str = "1.3.6.1.511.10.3.39";
pub const szOID_SYNC_ROOT_CTL_EXT: &'static str = "1.3.6.1.511.10.3.50";
pub const szOID_HPKP_DOMAIN_NAME_CTL: &'static str = "1.3.6.1.511.10.3.60";
pub const szOID_HPKP_HEADER_VALUE_CTL: &'static str = "1.3.6.1.511.10.3.61";
pub const szOID_KP_KERNEL_MODE_HAL_EXTENSION_SIGNING: &'static str = "1.3.6.1.511.61.5.1";
pub const szOID_WINDOWS_STORE_SIGNER: &'static str = "1.3.6.1.511.76.3.1";
pub const szOID_DYNAMIC_CODE_GEN_SIGNER: &'static str = "1.3.6.1.511.76.5.1";
pub const szOID_MICROSOFT_PUBLISHER_SIGNER: &'static str = "1.3.6.1.511.76.8.1";
pub const szOID_YESNO_TRUST_ATTR: &'static str = "1.3.6.1.511.10.4.1";
pub const szOID_SITE_PIN_RULES_INDEX_ATTR: &'static str = "1.3.6.1.511.10.4.2";
pub const szOID_SITE_PIN_RULES_FLAGS_ATTR: &'static str = "1.3.6.1.511.10.4.3";
...
pub const szOID_ROOT_PROGRAM_FLAGS: &'static str = "1.3.6.1.511.60.1.1";
...
pub const szOID_ENROLL_EK_INFO: &'static str = "1.3.6.1.511.21.23";
pub const szOID_ENROLL_AIK_INFO: &'static str = "1.3.6.1.511.21.39";
pub const szOID_ENROLL_ATTESTATION_STATEMENT: &'static str = "1.3.6.1.511.21.24";
pub const szOID_ENROLL_KSP_NAME: &'static str = "1.3.6.1.511.21.25";
pub const szOID_ENROLL_EKPUB_CHALLENGE: &'static str = "1.3.6.1.511.21.26";
pub const szOID_ENROLL_CAXCHGCERT_HASH: &'static str = "1.3.6.1.511.21.27";
pub const szOID_ENROLL_ATTESTATION_CHALLENGE: &'static str = "1.3.6.1.511.21.28";
pub const szOID_ENROLL_ENCRYPTION_ALGORITHM: &'static str = "1.3.6.1.511.21.29";
...
pub const szOID_ENROLL_EKVERIFYKEY: &'static str = "1.3.6.1.511.21.30";
pub const szOID_ENROLL_EKVERIFYCERT: &'static str = "1.3.6.1.511.21.31";
pub const szOID_ENROLL_EKVERIFYCREDS: &'static str = "1.3.6.1.511.21.32";
pub const szOID_ENROLL_SCEP_ERROR: &'static str = "1.3.6.1.511.21.33";
pub const szOID_ENROLL_SCEP_SERVER_STATE: &'static str = "1.3.6.1.511.21.34";
pub const szOID_ENROLL_SCEP_CHALLENGE_ANSWER: &'static str = "1.3.6.1.511.21.35";
pub const szOID_ENROLL_SCEP_CLIENT_REQUEST: &'static str = "1.3.6.1.511.21.37";
pub const szOID_ENROLL_SCEP_SERVER_MESSAGE: &'static str = "1.3.6.1.511.21.38";
pub const szOID_ENROLL_SCEP_SERVER_SECRET: &'static str = "1.3.6.1.511.21.40";
pub const szOID_ENROLL_KEY_AFFINITY: &'static str = "1.3.6.1.511.21.41";
pub const szOID_ENROLL_SCEP_SIGNER_HASH: &'static str = "1.3.6.1.511.21.42";
pub const szOID_ENROLL_EK_CA_KEYID: &'static str = "1.3.6.1.511.21.43";
...
pub const szOID_CMC_ADD_ATTRIBUTES: &'static str = "1.3.6.1.511.10.10.1";
...
pub const szOID_CERT_STRONG_SIGN_OS_PREFIX: &'static str = "1.3.6.1.511.72.1.";
pub const szOID_CERT_STRONG_SIGN_OS_1: &'static str = "1.3.6.1.511.72.1.1";
pub const szOID_CERT_STRONG_SIGN_OS_CURRENT: &'static str = szOID_CERT_STRONG_SIGN_OS_1;
pub const szOID_CERT_STRONG_KEY_OS_PREFIX: &'static str = "1.3.6.1.511.72.2.";
pub const szOID_CERT_STRONG_KEY_OS_1: &'static str = "1.3.6.1.511.72.2.1";
...
pub const szOID_CERT_PROP_ID_PREFIX: &'static str = "1.3.6.1.511.10.11.";
pub const szOID_CERT_KEY_IDENTIFIER_PROP_ID: &'static str = "1.3.6.1.511.10.11.20";
pub const szOID_CERT_ISSUER_SERIAL_NUMBER_MD5_HASH_PROP_ID: &'static str
    = "1.3.6.1.511.10.11.28";
pub const szOID_CERT_SUBJECT_NAME_MD5_HASH_PROP_ID: &'static str = "1.3.6.1.511.10.11.29";
pub const szOID_CERT_MD5_HASH_PROP_ID: &'static str = "1.3.6.1.511.10.11.4";
pub const szOID_CERT_SIGNATURE_HASH_PROP_ID: &'static str = "1.3.6.1.511.10.11.15";
pub const szOID_DISALLOWED_HASH: &'static str = szOID_CERT_SIGNATURE_HASH_PROP_ID;
pub const szOID_CERT_DISALLOWED_FILETIME_PROP_ID: &'static str = "1.3.6.1.511.10.11.104";
...
pub const szOID_ROOT_PROGRAM_AUTO_UPDATE_CA_REVOCATION: &'static str = "1.3.6.1.511.60.3.1";
pub const szOID_ROOT_PROGRAM_AUTO_UPDATE_END_REVOCATION: &'static str = "1.3.6.1.511.60.3.2";
pub const szOID_ROOT_PROGRAM_NO_OCSP_FAILOVER_TO_CRL: &'static str = "1.3.6.1.511.60.3.3";
...
pub const CERT_PROT_ROOT_PEER_USAGES_DEFAULT_A: &'static str
    = "1.3.6.1.5.5.7.3.2\01.3.6.1.5.5.7.3.4\01.3.6.1.511.10.3.4\0";
